...
<head>
    ...
    <title>500 - Internal Server Error - Smart WMS</title>
...
<body>
    ...
    <div class="container-xxl container-p-y">
        <div class="misc-wrapper">
            <h2 class="mb-2 mx-2" style="font-size: 6rem;">500</h2>
            <h3 class="mb-2 mx-2">Internal Server Error 🛠️</h3>
            <p class="mb-4 mx-2">Oops! Something went wrong on our server.</p>
