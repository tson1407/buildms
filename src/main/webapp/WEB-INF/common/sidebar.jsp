...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme" role="navigation" aria-label="Main navigation">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item ${param.activeMenu == 'dashboard' ? 'active' : ''}">
            <a href="${contextPath}/dashboard" class="menu-link">
        ...
        <li class="menu-item ${param.activeMenu == 'profile' ? 'active' : ''}">
            <a href="${contextPath}/profile" class="menu-link">
                <i class="menu-icon tf-icons bx bx-user"></i>
                <div class="text-truncate">My Profile</div>
            </a>
        </li>

        <li class="menu-item ${param.activeMenu == 'change-password' ? 'active' : ''}">
            <a href="${contextPath}/auth?action=changePassword" class="menu-link">
