...
<head>
    <jsp:include page="/WEB-INF/common/head.jsp">
        <jsp:param name="pageTitle" value="Add Provider" />
    </jsp:include>
</head>
<body>
    <!-- Layout wrapper -->
                ...
                <div class="content-wrapper">
                    ...
                    <main class="container-xxl flex-grow-1 container-p-y" role="main">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-6">
                            <h4 class="mb-0">
                                <i class="bx bx-plus-circle me-2"></i>Add New Provider
                            </h4>
                                        ...
                                        <form action="${contextPath}/provider" method="post">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="form-text">
                                                    ...
                                                    Unique identifier for the provider. Cannot be changed easily.
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex gap-3 pt-3">
                                                <button type="submit" class="btn btn-primary">
                                                    <i class="bx bx-save me-1"></i>Create Provider
                                                </button>
                                                <a href="${contextPath}/provider?action=list" class="btn btn-outline-secondary">
                            ...
                            <div class="col-xl-4">
                                <div class="card mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex mb-3">
                                            ...
                                            <div>
                                                <h6 class="mb-1">Provider Code</h6>
                                                <small class="text-muted">
                                                    Must be unique. Use a consistent format like PROV001, PROV002, etc.
                                                </small>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div>
                                                ...
                                                <small class="text-muted">
                                                    Include all relevant contact details for purchasing and communication.
                                                </small>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card bg-light-primary">
                                    <div class="card-body">
                                        ...
                                        <ul class="mb-0 ps-3">
                                            <li class="mb-2">
                                                New providers are <strong>Active</strong> by default
                                            </li>
                                            <li class="mb-2">
                                                Inactive providers cannot be selected for new Inbound requests
                                            </li>
                                        </ul>
                                    </div>
                                </div>
