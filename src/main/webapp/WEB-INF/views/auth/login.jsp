...
<head>
    ...
    <meta name="description" content="Smart Warehouse Management System - Login" />
            ...
            <div class="authentication-inner">
                ...
                <div class="card px-sm-6 px-0">
                    <div class="card-body">
                        ...
                        <h4 class="mb-1">Welcome to Smart WMS! 👋</h4>
                        ...
                        <!-- Login Form -->
                        <form id="formAuthentication" class="mb-6" action="${contextPath}/auth" method="post">
                        ...
                        <p class="text-center text-muted">
                            <small>Smart Warehouse Management System &copy; 2026</small>
                        </p>
                    </div>
                </div>
                <!-- /Login Card -->
