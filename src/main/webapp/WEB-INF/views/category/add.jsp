    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            ...
            <jsp:include page="/WEB-INF/common/sidebar.jsp">
                ...
                <jsp:param name="activeSubMenu" value="category-add" />
            </jsp:include>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-lg-6">
                                <div class="card bg-light">
                                    <div class="card-body">
                                        <h6 class="card-title">
                                            <i class="bx bx-info-circle me-2 text-info"></i>Help
                                        </h6>
                                        <p class="card-text small">
                                            Categories help organize your products for easier management and navigation.
                                        </p>
                                        <ul class="small mb-0">
                                            <li>Category name must be unique</li>
                                            <li>Description is optional but recommended</li>
                                            <li>You can edit categories later</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
